...
| **SUMBER DANA** | **Terisi otomatis dari nomor rekening sumber pada bukti** (pemetaan rekening → Pendapatan Usaha / Kas Lain Usaha / THR-CUTI). Pencocokan juga lewat **nama pemilik/aplikasi** (mis. blu *Andre Stefano Wowor* → THR/Cuti) dan **nomor yang disamarkan** — cukup nama bank + angka yang masih terlihat (mis. `Mandiri •••••••••5620`, `BCA 026-3**-**85`, `BNI *******055`, `BRI 1543 **** **** 507`). Bila tak terbaca: BOC(1201)→Uang Saku, atau pola SUMBER DANA tersering per POS dari history. Bisa dikoreksi. |
